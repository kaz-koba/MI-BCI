...
if __name__ == "__main__":
    ...
    path_a = [(PATHfile.edfpath("sonota","[2020.11.30]", "1"), PATHfile.eventpath("sonota", "[2020.11.30]", "1"))]
    path_b = [(PATHfile.edfpath("sonota","[2020.11.30]", "2"), PATHfile.eventpath("sonota", "[2020.11.30]", "2"))]
